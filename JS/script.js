document.addEventListener('DOMContentLoaded', function () {
  let historialCotizaciones = JSON.parse(localStorage.getItem('historialCotizaciones')) || []; // Arreglo para almacenar historial de cotizaciones
    ...
    try {
      ...
      fetch('data.json')
        ...
        .then(data => {
          ...
          localStorage.setItem('historialCotizaciones', JSON.stringify(historialCotizaciones)); // Guardar el historial en localStorage
  ...
  function mostrarFormularioConfirmacion() {
    ...
    document.getElementById('formularioConfirmacion').addEventListener('submit', function (event) {
      ...
      // Limpiar la pantalla, pasando true para indicar que se confirmó el evento
  ...
  function limpiarPantalla(confirmado) {
    if (confirmado) {
      // Limpiar el historial de cotizaciones solo si se confirmó el evento
      historialCotizaciones = [];
      localStorage.removeItem('historialCotizaciones'); // Eliminar el historial de localStorage
    }
